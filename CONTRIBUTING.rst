...
==============================
:Info: Those are the contribution rules for Number Namer.
...
2. The following fancy Unicode characters should be used when
   ...
   appear elsewhere.
3. K&R style applies. Braces are mandatory in all blocks (even one-line
   blocks). Braces are on the same lines as class names and function
   signatures. Use 4-space indents.
